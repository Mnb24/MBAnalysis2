...
def count_words_in_text(text, words):
    words_text = re.findall(r'\w+', text, flags=re.UNICODE)  # Use Unicode flag for Devanagari text
...
if st.button('Analyze'):
    if words_to_search:
        ...
        for file_path, file_name in zip(file_paths, file_names):
            ...
            text = response.content.decode('utf-8')  # Decode content properly
